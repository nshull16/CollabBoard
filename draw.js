...
// list of valid client/server UPC messages
var UPC = net.user1.orbiter.UPC;
// The ID of the room users will join in order to draw together
var roomID = "examples.uniondraw";
// A hash of client attribute names used in our application.
var Attributes = {THICKNESS:"thickness",
                  COLOR:"color"};
// A hash of room message names used in our application. MOVE means move the
...
function init () {
  ...
  setStatus("Connecting to CollabBoard...");
}
...
//==============================================================================
// Triggered when the connection to the server is ready
function readyListener (e) {
  // Register for UPC messages from the server
...
// Triggered when the connection to the server is closed
...
//==============================================================================
// Triggered when Server sends a "snapshot" describing the drawing room,
// including a list of users supplied as unnamed arguments after the
// roomAttributes parameter.
...
function broadcastPath () {
  ...
  // Parameters are: messageName, roomID, includeSelf, filters, ...args.
